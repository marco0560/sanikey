...
| 07 | Build pipeline | DA-035..DA-040, DA-091..DA-103 | [x] | `UV_CACHE_DIR=/tmp/uv-cache uv run python scripts/validate_repo.py` passed | `e82e7df` |
| 08 | AI proposal interface | DA-054..DA-060, DA-100, DA-117 | [x] | `UV_CACHE_DIR=/tmp/uv-cache uv run python scripts/validate_repo.py` passed | `6b67c43` |
...
| 11 | USB export and deploy | DA-004..DA-005, DA-104..DA-112, DA-125..DA-129 | [x] | `UV_CACHE_DIR=/tmp/uv-cache uv run python scripts/validate_repo.py` passed | Pending |
